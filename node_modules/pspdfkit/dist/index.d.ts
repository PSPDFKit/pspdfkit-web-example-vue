...
import React__default, { FocusEvent as FocusEvent$1, KeyboardEvent as KeyboardEvent$1, SyntheticEvent, ElementType, ReactNode, JSXElementConstructor, SVGProps, CSSProperties, Key, ReactHTML, ForwardedRef } from 'react';
...
declare class Block<T extends AnyComponent = AnyComponent> {
     ...
     */
    createComponent(key?: Key): React__default.ReactElement;
    /**
...
interface SharedProps$3 extends StylingProps {
    ...
    onAdd?: () => void;
    /**
     * Callback fired when the user clicks the add button on a preview.
     *
     * @param id
     */
    ...
    variant?: "wide" | "narrow";
    /**
     * The actions to disable on the preview.
     *
     * @default [ ]
     */
    disabledActions?: ("add" | "remove")[];
}
...
declare const PSPDFKit: {
    ...
    defaultElectronicSignatureColorPresets: ColorPreset[];
    defaultToolbarItems: readonly [{
    ...
    defaultStampAnnotationTemplates: StampAnnotation<IStampAnnotation>[];
    defaultAnnotationsSidebarContent: readonly [typeof EllipseAnnotation, typeof HighlightAnnotation, typeof ImageAnnotation, typeof InkAnnotation, typeof LineAnnotation, typeof NoteAnnotation, typeof PolygonAnnotation, typeof PolylineAnnotation, typeof RectangleAnnotation, typeof SquiggleAnnotation, typeof StampAnnotation, typeof StrikeOutAnnotation, typeof TextAnnotation, typeof UnderlineAnnotation, typeof WidgetAnnotation];
