# PSPDFKit for Web Example – Vue 3

This example shows how to integrate [PSPDFKit for Web](https://pspdfkit.com/web/) into a Vue.js app.

If you're looking for the Vue 2 example, you can switch to the [`vue-2` branch](https://github.com/PSPDFKit/pspdfkit-web-example-vue/tree/vue-2).
